...
**Student Name:** Harshvardhan Om  
**Roll Number:** 24BCE10511  
...
```bash
git clone https://github.com/harshvardhanom/oss-audit-24BCE10511
cd oss-audit-24BCE10511
```
...
the VITyarthi OSS NGMC Capstone Project by Harshvardhan Om (24BCE10511).
